...
(loading=="Done")&&<>
  ...
  <h1 className='my-10 font-mono ring-2 rounded-xl bg-gradient-to-r from-cyan-700 shadow-2xl to-blue-800 text-gray-200 p-4 w-[60%] mx-auto'>Video Transcriber</h1>
    <div className="grid grid-cols-2">
    <div className={file&&"col-span-1 m-auto"||"col-span-2"}>
      <form onSubmit={handleSubmitVid} >
      <div className="flex items-center justify-center w-full">
    <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-[60vh] h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
        <div className="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">MP4, MP3, WAV</p>
        </div>
        <input id="dropzone-file" type="file" className="text-black bg-transparent hidden" accept="" onChange={handlechange} />
    </label>
</div> 
      ...
      {file&&<div className={"col-span-1"}>
            <h1>
              Preview
            </h1> 
          <video width="100%" autoPlay controls loop muted className="mx-auto">
